defmodule TodoElixir.TodosTest do
  ...
  describe "todos" do
    ...
    @valid_attrs %{finished: true, name: "some name"}
    @update_attrs %{finished: false, name: "some updated name"}
    @invalid_attrs %{finished: nil, name: nil}
